	...
	<div class="row">
		<div class="col-sm-12 col-md-12">
			<ul class="breadcrumb">
			  ...
			  <!--<li id="eid_management/menus/submission_report" class="back_page"><a href="#"><?php echo @$report_text; ?></a> <span class="divider">/</span></li> -->
			  <li class="active"><font color="#0000FF">APPROVED CONSUMPTION REPORT ::</font> <?php echo @$platform.' ['.@strtoupper($labname). ' '.@$monthname.' '.@$year; ?>] &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span style="">Date Submitted <?php echo $datesubmitted;?></span></li>
			</ul>
		</div>
		<?php
		$slab		= $lab; 
