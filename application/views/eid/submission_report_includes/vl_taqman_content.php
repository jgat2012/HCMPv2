<tr>
	...
	<td><div align="center">
	  <input type="text"  class="input-sm" style = "background:#F6F6F6; color:#999999; font-weight:bold" name="vuqualkit" size="10"  value="<?php echo ceil(@$vuqualkit);?>"/>
    </div></td>
	<td><div align="center">
	...
	<td><div align="center">
	  <input type="text"  class="input-sm" value="<?php echo @$vequalkit;?>" style = "background:#F6F6F6;font-weight:bold" name="vequalkit" size="10" />
    </div></td>
	<td><div align="center">
...
<tr>
	...
	<td style="background-color:#FFFFFF"><div align="center">
	  <input type="text"  class="input-sm" name="vuspexagent" size="10" style = "background:#ffffff; color:#999999; font-weight:bold" value="<?php echo ceil(@$vuspexagent);?>"/>
    </div></td>
	<td style="background-color:#FFFFFF"><div align="center">
	...
	<td style="background-color:#FFFFFF"><div align="center">
	  <input type="text"  class="input-sm" value="<?php echo @$vespexagent;?>"  style = "background:#ffffff;font-weight:bold" name="vespexagent" size="10" />
    </div></td>
	<td style="background-color:#FFFFFF"><div align="center">
...
<tr>
	...
	<td>-</td>
	<td><div align="center">
	  <input type="text" class="input-sm" name="vuampinput" size="10" style = "background:#F6F6F6; color:#999999; font-weight:bold" value="<?php echo ceil(@$vuampinput);?>"/>
    </div></td>
	<td><div align="center">
	...
	<td><div align="center">
	  <input type="text"  class="input-sm" value="<?php echo @$veampinput;?>"  style = "background:#F6F6F6;font-weight:bold" name="veampinput" size="10" />
    </div></td>
	<td><div align="center">
...
<tr>
 ...
 <!--Flapless --> SPU</td>
	...
	<td style="background-color:#FFFFFF">-</td>
	<td style="background-color:#FFFFFF"><div align="center">
	  <input type="text" class="input-sm" name="vuampflapless" size="10" style = "background:#ffffff; color:#999999; font-weight:bold" value="<?php echo ceil(@$vuampflapless);?>"/>
    </div></td>
	<td style="background-color:#FFFFFF"><div align="center">
	...
	<td style="background-color:#FFFFFF"><div align="center">
	  <input type="text"  class="input-sm" value="<?php echo @$veampflapless;?>"  style = "background:#ffffff;font-weight:bold" name="veampflapless" size="10" />
    </div></td>
	<td style="background-color:#FFFFFF"><div align="center">
...
<tr>
	...
	<td>-</td>
	<td><div align="center">
	  <input type="text" class="input-sm" name="vuampwash" size="10" style = "background:#F6F6F6; color:#999999; font-weight:bold" value="<?php echo ceil(@$vuampwash);?>"/>
    </div></td>
	<td><div align="center">
	...
	<td><div align="center">
	  <input type="text" class="input-sm"  value="<?php echo @$veampwash;?>" style = "background:#F6F6F6;font-weight:bold" name="veampwash" size="10" />
    </div></td>
	<td><div align="center">
...
<tr>
	...
	<td style="background-color:#FFFFFF">-</td>
	<td style="background-color:#FFFFFF"><div align="center">
	  <input type="text" class="input-sm" name="vuampktips" size="10" style = "background:#ffffff; color:#999999; font-weight:bold" value="<?php echo ceil(@$vuampktips);?>"/>
    </div></td>
	<td style="background-color:#FFFFFF"><div align="center">
	...
	<td style="background-color:#FFFFFF"><div align="center">
	  <input type="text"  class="input-sm" value="<?php echo @$veampktips;?>" style = "background:#ffffff;font-weight:bold" name="veampktips" size="10" />
    </div></td>
	<td style="background-color:#FFFFFF"><div align="center">
...
<tr>
	...
	<td>-</td>
	<td><div align="center">
	  <input type="text" class="input-sm" name="vuktubes" size="10" style = "background:#F6F6F6; color:#999999; font-weight:bold" value="<?php echo ceil(@$vuktubes);?>"/>
    </div></td>
	<td><div align="center">
	...
	<td><div align="center">
	  <input type="text" class="input-sm"  value="<?php echo @$vektubes;?>" style = "background:#F6F6F6;font-weight:bold" name="vektubes" size="10"/>
    </div></td>
	<td><div align="center">
