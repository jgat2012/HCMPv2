<tr style='border-bottom:1px dashed #CCCCCC; '>
	<td>1</td>
	<td width="350px" colspan="">Molecular, m2000 RealTime PCR, Amplification Reagent Kit, Hiv-1, Quantitative  (<strong>Manf. code</strong> 2G3190)</td>
	<td><div align="center"><!--<input type="hidden"  name="voqualkit" size="5"  value="<?php //echo $vopeningqualkit;?>" style="color:#999999; font-weight:bold"/> -->
...
<td><div align="center">
  <input type="text" name="vqualkitlotno" class="input-sm" size="10" style = "font-weight:bold; color:#999999" value="<?php echo $vqualkitlotno;?>"/>
	...
	<td><div align="center">
	  <input type="text" class="input-sm" name="o_rvqualkit"    size="5" style = "background:#FFFFFF;font-weight:bold"   value="<?php echo $vrqualkit;?>"  />
	</div></td>
	<td><div align="center">
	  <input type="text" class="input-sm" name="rvqualkit"    size="5" style = "background:#FFFFFF;font-weight:bold"   value="<?php echo $vrqualkit;?>"  />
	</div></td>
</tr>

<tr style='border-bottom:1px dashed #CCCCCC; '>
	<td>2</td>
	<td>Molecular, m2000 RealTime PCR, Control Kit, 8 Low Positive, 8 High Positive, 8 Negative</td>
	<td><div align="center"><!--<input type="hidden"  name="vocontrol" size="5"  value="<?php //echo $vopeningcontrol;?>" style="color:#999999; font-weight:bold"/> -->
...
<td style="background-color:#FFFFFF"><div align="center">
  <input type="text" class="input-sm" name="vcontrollotno" size="10" style = "font-weight:bold; color:#999999" value="<?php echo $vcontrollotno;?>"/>
	...
	<td><div align="center"><input type="text" class="input-sm"  name="rvcontrol" size="5"    style = "background:#FFFFFF;font-weight:bold"   value="<?php echo $vrcontrol;?>" /></div></td>
</tr>

<tr class="even" style='border-bottom:1px dashed #CCCCCC; '>
	<td>3</td>
	<td>Molecular, m2000 Realtime PCR, mSample Preparation System Bulk Lysis Buffer, 3 x 70ml</td>
	<td style="background-color:#FFFFFF"><div align="center"><!--<input type="hidden"  name="vobuffer" size="5"  value="<?php //echo $vopeningbuffer;?>" style="color:#999999; font-weight:bold"/> -->
...
<td style="background-color:#FFFFFF"><div align="center">
  <input type="text" class="input-sm" name="vbufferlotno" size="10" style = "font-weight:bold; color:#999999" value="<?php echo $vbufferlotno;?>"/>
	...
	<td style="background-color:#FFFFFF"><div align="center"><input type="text" class="input-sm" name="rvbuffer"    size="5" style = "background:#FFFFFF;font-weight:bold"   value="<?php echo $vrbuffer;?>"  /></div></td>
</tr>

<tr style='border-bottom:1px dashed #CCCCCC; '>
	<td>4</td>
	<td>Molecular, m2000 RealTime PCR, Preparation System Reagents RNA, 4 x 24 Preps</td>
	<td><div align="center"><!--<input type="hidden" name="vopreparation" size="5"  value="<?php //echo $vopeningpreparation;?>" style="color:#999999; font-weight:bold"/> -->
...
<td style="background-color:#FFFFFF"><div align="center">
  <input type="text" class="input-sm" name="vpreparationlotno" size="10" style = "font-weight:bold; color:#999999" value="<?php echo $vpreparationlotno;?>"/>
	...
	<td><div align="center"><input type="text" class="input-sm" name="rvpreparation" size="5"    style = "background:#FFFFFF;font-weight:bold"   value="<?php echo $vrpreparation;?>" /></div></td>
</tr>
...
<tr class="even" style='border-bottom:1px dashed #CCCCCC; '>
	...
	<td style="background-color:#FFFFFF"><div align="center">
	  <!--<input type="hidden" name="voadhesive" size="5"  value="<?php //echo $vopeningadhesive;?>" style="color:#999999; font-weight:bold"/> -->
...
<td style="background-color:#FFFFFF">-</td><td style="background-color:#FFFFFF"><div align="center"><input type="hidden" name="vuadhesive" size="5" value="<?php echo ceil($vuadhesive);?>"  style="color:#999999; font-weight:bold" />
	  ...
	  <td style="background-color:#FFFFFF"><div align="center"><input type="text" class="input-sm" name="rvadhesive" size="5"    style = "background:#FFFFFF;font-weight:bold"   value="<?php echo $vradhesive;?>" /></div></td>
</tr>
<tr style='border-bottom:1px dashed #CCCCCC; '>
	<td>6</td>
	<td>Molecular, m2000 RealTime PCR, PCR Plate, Plastic, 96-Well, Deep</td>
	<td style="background-color:#FFFFFF"><div align="center">
	  <!--<input type="hidden"  name="vodeepplate" size="5"  value="<?php //echo $vopeningdeepplate;?>" style="color:#999999; font-weight:bold"/> -->
...
<td><div align="center">
	...
	<td><div align="center"><input type="text" class="input-sm"  name="rvdeepplate" size="5"  style = "background:#FFFFFF;font-weight:bold"   value="<?php echo $vrdeepplate;?>" /></div></td>
</tr>
<tr class="even" style='border-bottom:1px dashed #CCCCCC; '>
	<td>7</td>
	<td>Molecular, m2000 RealTime PCR, Master Mix Tubes/caps, Plastic, 10ml </td>
	<td style="background-color:#FFFFFF"><div align="center">
	  <!--<input type="hidden"  name="vomixtube" size="5"  value="<?php //echo $vopeningmixtube;?>" style="color:#999999; font-weight:bold"/> -->
...
<td style="background-color:#FFFFFF"><div align="center"><input type="hidden"  name="vumixtube" size="5" value="<?php echo ceil($vumixtube);?>"  style="color:#999999; font-weight:bold"  />
	...
	<td style="background-color:#FFFFFF"><div align="center"><input type="text" class="input-sm"  name="rvmixtube" size="5"    style = "background:#FFFFFF;font-weight:bold"   value="<?php echo $vrmixtube;?>"  /></div></td>
</tr>
<tr style='border-bottom:1px dashed #CCCCCC; '>
	<td>8</td>
	<td>Molecular, m2000 RealTime PCR, Reaction Vessles (PCR Tube), 5mL, Plastic, 12 x 75mm</td>
	<td style="background-color:#FFFFFF"><div align="center">
	  <!--<input type="hidden"  name="voreactionvessels" size="5"  value="<?php //echo $vopeningreactionvessels;?>" style="color:#999999; font-weight:bold"/> -->
...
<td><div align="center"><input type="hidden"  name="vureactionvessels" size="5" value="<?php echo ceil($vureactionvessels);?>"  style="color:#999999; font-weight:bold" />
	...
	<td><div align="center"><input type="text" class="input-sm"  name="rvreactionvessels" size="5"  style = "background:#FFFFFF;font-weight:bold"   value="<?php echo $vrreactionvessels;?>" /></div></td>
</tr>
<tr class="even" style='border-bottom:1px dashed #CCCCCC; '>
	<td>9</td>
	<td>Molecular, m2000 RealTime PCR, Reagent Vessel, 200mL, Plastic</td>
	<td style="background-color:#FFFFFF"><div align="center">
	  <!--<input type="hidden"  name="voreagent" size="5"  value="<?php //echo $vopeningreagent;?>" style="color:#999999; font-weight:bold"/> -->
...
<td style="background-color:#FFFFFF"><div align="center"><input type="hidden" name="vureagent" size="5" value="<?php echo ceil($vureagent);?>"  style="color:#999999; font-weight:bold"  />
	...
	<td style="background-color:#FFFFFF"><div align="center"><input type="text" class="input-sm" name="rvreagent" size="5" style = "background:#FFFFFF;font-weight:bold"   value="<?php echo $vrreagent;?>" /></div></td>
</tr>
<tr style='border-bottom:1px dashed #CCCCCC; '>
	<td>10</td>
	<td>Molecular, m2000 RealTime PCR, Microplate, 96-Well, Optical Reaction, Clear</td>
	<td style="background-color:#FFFFFF"><div align="center">
	  <!--<input type="hidden" name="voreactionplate" size="5"  value="<?php //echo $vopeningreactionplate;?>" style="color:#999999; font-weight:bold"/> -->
...
<td><div align="center"><input type="hidden" name="vureactionplate" size="5" value="<?php echo ceil($vureactionplate);?>"  style="color:#999999; font-weight:bold" />
        <input type="text" class="input-sm" name="vureactionplate2" size="5" value="<?php echo ceil($vureactionplate);?>"  style="color:#999999; font-weight:bold" />
    </div></td><td><div align="center"><input type="text" class="input-sm" name="vwreactionplate"  size="5" style="color:#999999; font-weight:bold"  value="<?php echo $vwreactionplate;?>" /></div></td>
	<td><div align="center"><input type="text" class="input-sm"  name="vpreactionplate"  size="5" style="color:#999999; font-weight:bold" value="<?php echo $vlreactionplatereceived;?>" /></div></td>
	<td><div align="center"><input type="text" class="input-sm" name="vireactionplate"  size="5" style="color:#999999; font-weight:bold"  value="<?php echo $vireactionplate;?>" /></div></td>
	<td><div align="center"><input type="text" class="input-sm" name="vereactionplate" size="5" style="color:#999999; font-weight:bold"  value="<?php echo $vereactionplate;?>" /></div></td>
	<td><div align="center"><input type="text" class="input-sm" name="o_rvreactionplate" size="5" style = "background:#FFFFFF;font-weight:bold"   value="<?php echo $vrreactionplate;?>" /></div></td>
	<td><div align="center"><input type="text" class="input-sm" name="rvreactionplate" size="5" style = "background:#FFFFFF;font-weight:bold"   value="<?php echo $vrreactionplate;?>" /></div></td>
</tr>
<tr class="even" style='border-bottom:1px dashed #CCCCCC; '>
	<td>11</td>
	<td>Molecular, m2000 RealTime PCR, Pipet Tips (DiTis), Disposable, with Filter, 1000&Acirc;&micro;L</td>
	<td style="background-color:#FFFFFF"><div align="center">
	  <!--<input type="hidden" name="vo1000disposable" size="5"  value="<?php //echo $vopening1000disposable;?>" style="color:#999999; font-weight:bold"/> -->
...
<td style="background-color:#FFFFFF"><div align="center"><input type="hidden" name="vu1000disposable" size="5" value="<?php echo ceil($vu1000disposable);?>"  style="color:#999999; font-weight:bold" />
	...
	<td style="background-color:#FFFFFF"><div align="center"><input type="text" class="input-sm" name="rv1000disposable" size="5"    style = "background:#FFFFFF;font-weight:bold"   value="<?php echo $vr1000disposable;?>" /></div></td>
</tr>
<tr style='border-bottom:1px dashed #CCCCCC; '>
	<td>12</td>
	<td>Molecular, m2000 RealTime PCR, Pipet Tips (DiTis), Disposable, with Filter, 200&Acirc;&micro;L</td>
	<td style="background-color:#FFFFFF"><div align="center">
	  <!--<input type="hidden" name="vo200disposable" size="5"  value="<?php //echo $vopening200disposable;?>" style="color:#999999; font-weight:bold"/> -->
...
<td><div align="center"><input type="hidden"  name="vu200disposable" size="5" value="<?php echo ceil($vu200disposable);?>"  style="color:#999999; font-weight:bold" />
	...
	<td><div align="center"><input type="text" class="input-sm"  name="rv200disposable" size="5"     style = "background:#FFFFFF;font-weight:bold"   value="<?php echo $vr200disposable;?>" /></div></td>
</tr>
<tr class="even">
...
<td colspan="2"><textarea name="vicomments" cols="30" rows="2" style="font-family:monospace; font-size:11.2px; border:none" disabled="disabled" > <?php echo $vicomments;?> </textarea></td>	
<td colspan="3" style="background-color:#F2F2F2"><div align="right"><strong>Comments concerning <font color="#009900">positive adjustments</font><br /><small>( eg. where were the kits were received from. )</small></strong></div></td>
  <td colspan="4">
  <input type="hidden" name="vrowID" size="5" value="<?php echo $vrowID;?>" style = "background:#FFFFCC; font-weight:bold"/>
  ...
  {
  	echo '<em>Kit Source = '.$vlabfrom.'<br>Date Received = '.$vldatereceived.'<br>Date Entered = '.$vldateentered.'</em>';
}?></td>				
</tr>